  ...
  angular.module('app')
    ...
    function storyFactory($log) {
      ...
      var space = {
        ...
        coolWeapon: ['Laser Swoard', 'Plasma Rifle', 'Ion Blade'],
        ...
        settingEvilLocation: ['on Planet X', 'on the Death Moon of Vega Prime', 'on the Crystal Planet of Quarton', 'aboard their starship Exterminator', 'deep in a black hole', 'hidden in the Magenta Nebula', ', asecret space station hidden in the rings of planet Protaxia', 'in the gas mines of Planet Vim']
      }
      var western = {
      ...
      var ninjas = {
        ...
        xFactorLeader: ['Silent Scorpian', 'Swift Jade', 'Silent Dragon', 'Iron Eagle'],
      ...
      function getxFactor(xfactor) {
        console.log('in factory', xfactor);
        switch (xfactor) {
          case 'ninjas':
            return ninjas
            break;
      ...
      function getPara(para) {
        switch (para) {
          ...
          return para1
            ...
            break;
          default:
          console.log('unknow paragraph selected');
