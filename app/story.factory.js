  ...
  angular.module('app')
    ...
    function storyFactory($log) {
      ...
      var plot = {
        ...
        plotHeroWins: ['#name# dove out of the way as #evilLeader# attacked once more. #name# whipped around, and landed the final strike on #evilLeader#.', '#evilLeader# wound up for a killing strike, #name# knew this was #pronounTheir# only chance. #pronounThey# tightened #pronounTheir# grip on #pronounTheir# trusty #coolWeapon# and attacked.', '"Hey Look!" #name# said, pointing over #evilLeader#\'s shoulder.<br>"What? Where?" #evilLeader# said, spinning around.<br>"Wow. I can\'t believe that worked," #name# said, and struck with #pronounTheir# #coolWeapon#.','"LEEEEEEEEEEEEROY JENKINNNNNS!!" #name# cried, attacking wildly.<br>"Huh?" #evilLeader# said. But it was too late. #name# was an unstoppable force, and #evilLeader# couldn\'t avoid the final strike.'],
        ...
        plotHappyEndingGood: ['It was over. Evil was finally banished from #settingMaster#. #name# looked at #pronounTheir# #coolWeapon#, a weapon of such power. Too much power. #pronounTheir# home avenged, #name# could finally rest. #pronounThey# dropped their #coolWeapon# to the ground, turned, and began the journey home.', 'Evil vanquished, #name# held #pronounTheir# #coolWeapon# high and let out a victorious shout. #evilLeader# may be defeated, but #name# knew another foe would soon rise up with ill intent.<br><br>"Let them come," #name# cried, "#settingMaster# is under my protection from now on!"'],
        plotHappyEndingEvil: ['Victorious, #name# picked up #evilLeader#\'s #coolWeapon#, tossing away #pronounTheir# own. Rising #pronounTheir# new weapon into the air, #name# called out, "#xFactor#! Your leader has fallen. You have a choice: Follow me. Or perish!" #name# laughed as #pronounTheir# new army assembled. #settingMaster# would soon belong to #pronounThem#.'],
        plotTragicEnding: ['#evilLeader# roared, "Now nothing stands in my way. #settingMaster# will fall."<br><br>"And what is to become of me?" #name# asked, trying to get up.<br><br>"You shall be my eternal prisoner," #evilLeader# said, kicking #name# down again, "And forever shall you bear witness the reign of evil you could not stop."', '"All too easy", #evilLeader# said, walking towards #name#\'s prone form. #name# tried to get to #pronounTheir# feet, tried to speak, to cry out, but nothing would come. The darkness was taking over now. There would be no coming back.']
      }
