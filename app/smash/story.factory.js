(function() {
  ...
  function storyFactory($log) {
    // worlds
    var kingdom = {
      settingMaster: ['The Kingdom of Magik'],
      settingHome: ['The Royal City of Magik-Tania', 'The Village of Forest Glenn', 'The Blight Lands of Rhahguhn', 'Hag\'s Bay, a fishing village'],
    ...
    var western = {
      ...
      settingTransport: ['on a big, black mustang', 'driving a swift wagon', 'without looking back', 'on foot', 'as the sun set'],
    ...
    var plot = {
      ...
      plotTwist: ['"Let\'s get right to it! The fighting, I mean," #name# said.<br>', '#name# felt #pronounTheir# anger boiling inside #pronounThem#. #evilLeader# didn\'t deserve to live! #name# would put and end to the #xFactor# and to anyone else who got in #pronounTheir#\'s way. In fact, #name# wouldn\'t stop until the whole world submitted to #pronounTheir# <span class="pd-corrupt">rule</span>!', '"Your coming was foretold by the Prophecy," #evilLeader# said, "It states only the greatest #coolJob# in the #settingLand# would come to face me."<br><br>"So, I <em>am</em> a #coolJob#!" #name# whispered.'],
      ...
      plotHeroWins: ['#name# dove out of the way as #evilLeader# attacked once more. #name# whipped around, and landed the final strike on #evilLeader#.', '#evilLeader# wound up for a killing strike, #name# knew this was #pronounTheir# only chance. #pronounThey# tightened #pronounTheir# grip on #pronounTheir# trusty #coolWeapon# and attacked.', '"Hey Look!" #name# said, pointing over #evilLeader#\'s shoulder.<br><br>"What? Where?" #evilLeader# said, spinning around.<br><br>"Wow. I can\'t believe that worked," #name# said, and struck with #pronounTheir# #coolWeapon#.','"LEEEEEEEEEEEEROY JENKINNNNNS!!" #name# cried, attacking wildly.<br><br>"Huh?" #evilLeader# said. But it was too late. #name# was an unstoppable force, and #evilLeader# couldn\'t avoid the final strike.'],
      plotHeroLoses: ['#name# gained the upper hand, and readied  #pronounTheir# #coolWeapon# for the final strike, but #evilLeader# lept forward, attacking ferociously! #name# was not fast enough. Clutching #pronounTheir# side, #pronounThey# fell to the ground.', '#evilLeader# was unstoppable. Attack after attack. They were relentless! #name# fought as hard as #pronounThey# could, but #evilLeader# was just too much for #pronounThem#. Finally, #name# dropped #pronounTheir# #coolWeapon# and fell the ground.', '"Hey Look!" #evilLeader# said, pointing over #name#\'s shoulder.<br><br>"What? Where?" #name# said, spinning around.<br><br>"Wow. What a chump," #evilLeader# said, and struck #name# down with their #coolWeapon#.'],
      plotHappyEndingGood: ['It was over. Evil was finally banished from #settingMaster#. #name# looked at #pronounTheir# #coolWeapon#, a weapon of such power. Too much power. #pronounTheir# home avenged, #name# could finally rest. #pronounThey# dropped their #coolWeapon# to the ground, turned, and began the journey home.', 'Evil vanquished, #name# held #pronounTheir# #coolWeapon# high and let out a victorious shout. #evilLeader# may be no more, but #name# knew another foe would soon rise up with ill intent.<br><br>"Let them come," #name# cried, "#settingMaster# is under my protection from now on!"'],
      plotHappyEndingEvil: ['Victorious, #name# picked up #evilLeader#\'s #coolWeapon#, tossing away #pronounTheir# own. <br><br>Rising #pronounTheir# new weapon into the air, #name# called out, "#xFactor#! Your leader has fallen. You have a choice: Follow me. Or perish!" #name# laughed as #pronounTheir# new army assembled. #settingMaster# would soon belong to #pronounThem#.'],
      plotTragicEnding: ['<br><br>#evilLeader# roared, "Now nothing stands in my way. #settingMaster# will fall."<br><br>"And what is to become of me?" #name# asked, trying to get up.<br><br>"You shall be my eternal prisoner," #evilLeader# said, kicking #name# down again, "And forever shall you bear witness the reign of evil you could not stop."', '<br><br>"All too easy", #evilLeader# said, walking towards #name#\'s prone form. #name# tried to get to #pronounTheir# feet, tried to speak, to cry out, but nothing would come. The darkness was taking over now. There would be no coming back.']
    }
    ...
    var para2 =['But adventure, as it often does, came to #name#! The #xFactor# <span class="pd-xfactorgroup">#xFactorGroup#</span> was attacking #home#! Despite being just a #lameJob#, #name# picked up a #lameWeapon# and fought back! #name# fought #sugarBravely#, but it wasn\'t enough, and sadly #home# was pillaged and left in ruins.'];

    var para3 = [
      'When the smoke cleared, #name# saw nothing but destruction all around #pronounThem#. Everyone and everything #pronounThey# had ever known was gone. #name# was all that remained.<br><br>Sticking out of the rubble, #name# saw a <span class="pd-coolweapon">#heroWeapon#</span>, the weapon of a <span class="pd-cooljob">#heroJob#</span>! #name# knew what #pronounThey# must do, avenge #pronounTheir# home and challenge <span class="pd-xfactorleader">#xFactorLeader#</span>, leader of the #xFactor.s#!',
      'As the smoke cleared #name# saw a figure approaching. It was #leader#, a <span class="pd-cooljob">#heroJob#</span>!<br><br>"#name#!" #leader# said. "You fought well. There are not many survivors. You must go and avenge our people! #sugarExcuse# Here, it\'s dangerous to go alone! Take this!"<br><br> #leader# handed #name# a <span class="pd-coolweapon">#heroWeapon#</span>.<br><br>"Go. Confront <span class="pd-xfactorleader">#xFactorLeader#</span>, leader of the #xFactor.s#! Avenge our people!"',
      'When the smoke cleared, #name# saw nothing but destruction all around #pronounThem#. Sticking out of the rubble, #name# saw a <span class="pd-coolweapon">#heroWeapon#</span>, the weapon of a <span class="pd-cooljob">#heroJob#</span>! #pronounThey# picked it up. As #pronounThey# did, a survivor came towards #pronounThem#.<br><br>"You are a #heroJob#?" they asked #name#.<br><br>"Well... I..." #name# said.<br><br>"Please, good hero, avenge our people. Confront <span class="pd-xfactorleader">#xFactorLeader#</span>, leader of the #xFactor.s#!"<br><br>#name# looked into the eyes of the survivor. "I will make the #xFactor.s# pay!" #name# said.'
    ];

    var para4 = ['Armed with #pronounTheir# new #coolWeapon#, #name# #sugarTraveled# #settingTransport#. #pronounTheir.capitalize# destination? The #xFactor#\'s <span class="pd-lair">#sugarLair#</span>, <span class="pd-evillocation">#settingEvilLocation#</span>. It would be a long journey, farther than #pronounThey# had ever ventured, but #name# was filled with #plotMotivation# #plotJourney#'];
    ...
    var para7good = ['#plotHeroWins# #evilLeader# was defeated. #plotHappyEndingGood#', '#plotHeroLoses# #evilLeader# laughed as #name# collapsed, exhausted and beaten. #plotTragicEnding#']

    var para7evil = ['#plotHeroWins# #evilLeader# was defeated. #plotHappyEndingEvil#', '#plotHeroLoses#.#evilLeader# laughed as #name# collapsed, exhausted and beaten. #plotTragicEnding#']
